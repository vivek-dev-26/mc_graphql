...
describe('My Test Cases', function () {
    var cases = [gqlServerLogin];
    var schema = graphql_tools_1.makeExecutableSchema({ typeDefs: typeDef_1.typeDefs, resolvers: resolvers_1.resolvers });
    cases.forEach(function (obj) {
        var query = obj.query, variables = obj.variables, expected = obj.expected;
        test("query: login(email: \"sra@gmail.com\", password: \"@!23\") {\n            data\n          }", function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, graphql_1.graphql(schema, query, null, variables)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, expect(result).toEqual(expected)];
                }
            });
        }); });
    });
